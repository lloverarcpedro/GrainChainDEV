...
##COMMODITY  PEER 3
export CORE_PEER_ADDRESS="peer3.commodity.io:7051"
#### JOIN THE CHANNEL ####
echo -e "\e[36m>======= JOINING peer $CORE_PEER_ADDRESS TO CHANNEL $GC_CHANNEL_NAME ============>\e[0m"
peer channel join -b /var/hyperledger/config/grainchainchannel-0.block
#### LIST CHANNELS ####
...
cd /var/hyperledger/config
##SILOSYS  PEER 1
export CORE_PEER_ADDRESS="peer1.silosys.io:7051"
...
##SILOSYS  PEER 2
export CORE_PEER_ADDRESS="peer2.silosys.io:7051"
#### JOIN THE CHANNEL ####
echo -e "\e[36m>======= JOINING peer $CORE_PEER_ADDRESS TO CHANNEL $GC_CHANNEL_NAME ============>\e[0m"
peer channel join -b /var/hyperledger/config/grainchainchannel-0.block
#### LIST CHANNELS ####
...
export CORE_PEER_MSPCONFIGPATH="/var/hyperledger/config/vagrant/ca/client/config/crypto-config/peerOrganizations/harvx.io/users/Admin@harvx.io/msp"
export CORE_PEER_LOCALMSPID=GrainchainMSP
configtxgen -outputAnchorPeersUpdate /var/hyperledger/config/config/peer-update-grainchain.tx -asOrg Grainchain -channelID $GC_CHANNEL_NAME  -profile GrainchainChannel
#### SUBMIT ANCHOR PEER UPDATE TX ####
peer channel update -f /var/hyperledger/config/config/peer-update-grainchain.tx -c grainchainchannel -o orderer1.grainchain.io:7050

export CORE_PEER_ADDRESS="peer1.commodity.io:7051"
export CORE_PEER_MSPCONFIGPATH="/var/hyperledger/config/vagrant/ca/client/config/crypto-config/peerOrganizations/commodity.io/users/Admin@commodity.io/msp"
export CORE_PEER_LOCALMSPID=CommodityMSP
configtxgen -outputAnchorPeersUpdate /var/hyperledger/config/config/peer-update-commodity.tx -asOrg Commodity -channelID $GC_CHANNEL_NAME  -profile GrainchainChannel
#### SUBMIT ANCHOR PEER UPDATE TX ####
peer channel update -f /var/hyperledger/config/config/peer-update-commodity.tx -c grainchainchannel -o orderer1.grainchain.io:7050

export CORE_PEER_ADDRESS="peer1.silosys.io:7051"
export CORE_PEER_MSPCONFIGPATH="/var/hyperledger/config/vagrant/ca/client/config/crypto-config/peerOrganizations/silosys.io/users/Admin@silosys.io/msp"
export CORE_PEER_LOCALMSPID=SilosysMSP
configtxgen -outputAnchorPeersUpdate /var/hyperledger/config/config/peer-update-silosys.tx -asOrg Silosys -channelID $GC_CHANNEL_NAME  -profile GrainchainChannel
#### SUBMIT ANCHOR PEER UPDATE TX ####
peer channel update -f /var/hyperledger/config/config/peer-update-silosys.tx -c grainchainchannel -o orderer1.grainchain.io:7050
