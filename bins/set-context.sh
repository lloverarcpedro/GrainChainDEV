...
# Address of the peer
export CORE_PEER_ADDRESS=peer1.$1.io:7051
...
export CORE_PEER_MSPCONFIGPATH=$PWD/config/crypto-config/peerOrganizations/$1.io/users/Admin@$1.io/msp
...
if [ "$2" == "tls" ] || [ "$2" == "raft" ] ; then
    ...
    export ORDERER_CA_ROOTFILE=$PWD/config/crypto-config/ordererOrganizations/grainchain.io/orderers/orderer.grainchain.io/msp/tlscacerts/tlsca.grainchain.io-cert.pem

    export CORE_PEER_TLS_ROOTCERT_FILE=$PWD/config/crypto-config/peerOrganizations/$1.io/peers/peer1.$1.io/tls/ca.crt
